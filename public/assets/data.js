...
window.SITE = {
  ...
  portfolio: [
    ...
    },
    {
      ...
      links: [{ label: '架构说明', url: '/knowledge/overview' }, { label: 'GitHub', url: 'https://github.com/wangyucosmos/zhuowang-workspace' }],
      images: []
    },
    {
  ...
  /* ---------- 简历 ---------- */
  resume: {
    pdf: '/resume.pdf',                       // 由 tools/make_resume_pdf.sh 从 /resume 页导出，改简历内容后重跑
    summary: '十年以上互联网运营经验，游戏运营出身，活动、用户、社群、内容都做过。习惯把一件事从策划、规则、文案做到原型和复盘，交付能直接进设计和开发。2026 年起把 AI 当协作者用：自己定义产品、让 AI 写代码，从零上线过多人协作网站和 macOS 应用。目前开放游戏运营 / 活动运营 / 社群运营方向的机会。',
    experience: [
